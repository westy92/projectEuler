...
public class Prob55 extends Euler
{
   ...
   private static boolean isLychrel(int n, int base)
   {
      long tempN = n;
      for ( int i = 0; i < 50; ++i ) // 50 iterations for n < 10,000
      {
         tempN += reverse(tempN, 10);
         if ( isPalindrome(tempN, base) )
            return false;
      }
      return true;
   }
